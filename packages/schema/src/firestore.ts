 ...
 *
 * NOTE: this file is the canonical, framework-free schema shared by every
 * app in the monorepo (web today, React Native tomorrow). It must not import
 * React, Next.js, or any UI code — only `firebase/*` types.
 */
